...
function linkSolidity4(contract: LinkableContract, libraryName: string, libraryAddress: string) {
...
function linkSolidity5(contract: LinkableContract, libraryName: string, libraryAddress: string) {
	const address = libraryAddress.replace("0x", "")
